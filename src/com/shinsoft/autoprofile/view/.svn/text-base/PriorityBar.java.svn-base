...
public class PriorityBar extends View 
{
	// Constants
    ...
    public PriorityBar(Context context) {
        super(context);
    }

    public PriorityBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PriorityBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.percentComplete <= 0) {
            ...
            if(this.percentComplete > 0 && this.percentComplete <= 30 )
                paint.setColor(WHITE);
            else if (this.percentComplete >= 31 && this.percentComplete <= 60)
