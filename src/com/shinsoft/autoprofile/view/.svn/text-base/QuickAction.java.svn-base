...
public class QuickAction extends CustomPopupWindow {
	...
	private final ImageView mIconTitle;
	 ...
	 */
	public QuickAction(View anchor,String title, int titleIconId) 
	{
		super(anchor);
		...
		mIconTitle	= (ImageView) root.findViewById(R.id.icontitle);
		if (titleIconId != 0)
			mIconTitle.setImageResource(titleIconId);
		else
			mIconTitle.setVisibility(View.GONE);
	 ...
	 */
	private View getActionItem(String title, Drawable icon, final OnClickListener listener) {
		final LinearLayout container	= (LinearLayout) inflater.inflate(R.layout.action_item, null);
